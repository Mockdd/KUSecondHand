...
FROM categories c,
(VALUES
  -- (상태,         최소월, 최대월, 감가율, 최소비율, 최대비율)
  ('new',          0,   3,   0.10, 0.80, 1.00),  -- 미개봉 신품, 3개월 이내: 10% 감가
  ('like_new',     0,   6,   0.20, 0.70, 0.90),  -- 거의새것, 6개월 이내: 20% 감가
  ('like_new',     6,  18,   0.30, 0.60, 0.80),  -- 거의새것, 6~18개월: 30% 감가
  ('good',         0,  12,   0.35, 0.55, 0.75),  -- 양호, 12개월 이내
  ('good',        12,  30,   0.45, 0.45, 0.65),  -- 양호, 12~30개월
  ('fair',         0,  24,   0.50, 0.40, 0.60),  -- 사용감, 24개월 이내
  ('fair',        24,  NULL, 0.60, 0.30, 0.50),  -- 사용감, 24개월 초과
  ('poor',         0,  NULL, 0.70, 0.20, 0.40)   -- 많이 사용
...
FROM categories c,
(VALUES
  ('new',          0,   3,   0.10, 0.80, 1.00),
  ('like_new',     0,   6,   0.25, 0.65, 0.85),
  ('like_new',     6,  18,   0.35, 0.55, 0.75),
  ('good',         0,  12,   0.40, 0.50, 0.70),
  ('good',        12,  24,   0.50, 0.40, 0.60),
  ('fair',         0,  24,   0.55, 0.35, 0.55),
  ('fair',        24,  NULL, 0.65, 0.25, 0.45),
...
(VALUES
  ...
  ('like_new', 0,  12,   0.30, 0.60, 0.80),
  ('good',     0,  18,   0.45, 0.45, 0.65),
  ('fair',     0,  NULL, 0.55, 0.35, 0.55),
  ('poor',     0,  NULL, 0.70, 0.20, 0.40)
) AS v(cond, min_mo, max_mo, dep, mn, mx)
...
VALUES
  ...
  -- 상태 기준 단독 규칙 (기간 0~∞)
  (NULL, 'new',      0, NULL, 0.15, 0.75, 1.00),
  (NULL, 'like_new', 0, NULL, 0.30, 0.60, 0.80),
  (NULL, 'good',     0, NULL, 0.40, 0.50, 0.70),
  (NULL, 'fair',     0, NULL, 0.55, 0.35, 0.55),
  (NULL, 'poor',     0, NULL, 0.70, 0.20, 0.40);
