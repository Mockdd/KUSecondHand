...
COMMENT ON COLUMN essential_packages.name         IS 'JSONB: {"ko": "한국어명", "en": "English name"}';
...
INSERT INTO essential_packages (template_type, name, region_group, housing_type) VALUES
    ('DORM_BASIC',    '{"ko":"기숙사 기본 패키지","en":"Dorm Basic Package"}',               NULL, 'dorm'),
    ('FLAT_FULL',     '{"ko":"자취/플랫셰어 풀 패키지","en":"Flat Full Package"}',           NULL, 'flat'),
    ('INCOMING_DORM', '{"ko":"고려대 기숙사 입주 패키지","en":"KU Incoming Dorm Package"}',  NULL, 'dorm')
